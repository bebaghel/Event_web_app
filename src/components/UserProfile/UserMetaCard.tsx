    ...
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-1 lg:gap-4 xl:flex-row">
            ...
            {/* social link */}
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end mt-4 lg:mt-0">
